  ...
  return (
    <div className='flex min-h-screen w-full'>
      ...
      <div className='w-1/2 relative flex items-center justify-center bg-cover'>
        ...
        {/* BG Image */}
        <img className='w-full h-full object-cover' src={restaurant} alt='Restuarant Image' />
        ...
        <blockquote className='absolute bottom-10 px-8 mb-10 text-2xl italic text-white'>
          ...
          <br />
          <span className='block mt-4 text-yellow-400'>Founder Of Ws</span>
        </blockquote>
      ...
      <div className="w-1/2 min-h-screen bg-[#1a1a1a] p-10">
        <div className="flex flex-col items-center gap-2">
          <img src={logo} alt="WS Logo" className='h-14 w-14 border-2 rounded-full p-1' />
        ...
        <h2 className='text-4xl text-center mt-10 font-semibold text-yellow-400 mb-10'>
          {isRegister ? "Emloyee Registration" : "Employee Login"}
        </h2>
